...
export type MelodyInRangeHardConstraintIR = typeof MelodyInRangeHardConstraintInit
...
export class MelodyInRangeHardConstraint implements HardConstraint<OctavedNote> {
	...
	name = noteConstraintTypeToName.get(MelodyInRangeHardConstraintInit.type) as string
