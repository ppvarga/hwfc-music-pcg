...
export abstract class MusicalKey extends NoteSet {
	...
	public static fromRootAndType(root: Note, type: MusicalKeyType): MusicalKey {
		switch(type){
			case "major":
...
export class HarmonicMinorKey extends MusicalKey {
	constructor(root: Note){
		super(root, [0, 2, 3, 5, 7, 8, 11], ["minor", "diminished", "augmented", "minor", "major", "major", "diminished"])
	}
...
export class MelodicMinorKey extends MusicalKey {
	constructor(root: Note){
		super(root, [0, 2, 3, 5, 7, 9, 11], ["minor", "minor", "augmented", "major", "major", "diminished", "diminished"])
	}
